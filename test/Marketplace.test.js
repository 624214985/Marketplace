...
contract('Marketplace', ([deployer, seller, buyer]) => {
    ...
    describe('products', async () => {
        ...
        it('creates products', async () => {
            ...
            assert.equal(event.price, web3.utils.toWei('1', 'Ether').toString(), 'price is correct')
        ...
        it('sells products', async () => {
            ...
            // FAILURE: Deployer tries to buy the product, i.e., product can't be purchased twice 一个产品不能重复购买两次
            await marketplace.purchaseProduct(productCount, { from: deployer, value: web3.utils.toWei('1', 'Ether') }).should.be.rejected;
            // FAILURE: Buyer tries to buy again, i.e., buyer can't be the seller 不能重复购买
